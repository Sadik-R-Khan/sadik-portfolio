...
export default function FreelanceProjects() {
  ...
  return (
    <section id="freelance" className="py-20 md:py-28 border-t border-slate-200/80 dark:border-slate-800 bg-slate-50/50 dark:bg-[#070B14] transition-colors duration-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {freelanceProjects.map((project) => (
            ...
            >
              ...
              <div className="px-6 pb-6 pt-4 border-t border-slate-100 dark:border-slate-800 flex flex-wrap gap-1.5 bg-slate-50/50 dark:bg-slate-950/40">
