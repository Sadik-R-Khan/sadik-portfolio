...
export default function Education() {
  ...
  return (
    <section id="education" className="py-20 md:py-28 border-t border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#0A0F1D] transition-colors duration-200">
        ...
        <div className="relative border-l-2 border-slate-200 dark:border-slate-800 ml-4 sm:ml-6 space-y-10 pl-6 sm:pl-8">
          {education.map((item, idx) => (
            <div key={idx} className="relative group">
              {/* Timeline Bullet */}
              <div className="absolute -left-[31px] sm:-left-[39px] top-1.5 w-4 h-4 rounded-full bg-white dark:bg-slate-900 border-4 border-blue-600 dark:border-blue-400 shadow-xs group-hover:scale-110 transition-transform"></div>

              <div className="bg-slate-50/70 dark:bg-slate-900/70 rounded-2xl border border-slate-200/80 dark:border-slate-800 p-6 sm:p-7 hover:border-slate-300 dark:hover:border-slate-700 hover:shadow-xs transition-all">
